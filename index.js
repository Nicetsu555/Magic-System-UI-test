...
function createDashboard(optionsMenu) {
    ...
    function writeCallTranscriptToStory(characterName, lines, wasIncoming) {
        ...
        const header = wasIncoming
            ? `[สายโทรศัพท์ — ${characterName} โทรหา ${userName} และคุยกันจนจบสาย]`
            : `[สายโทรศัพท์ — ${userName} โทรหา ${characterName} และคุยกันจนจบสาย]`;
