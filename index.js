...
function createDashboard(optionsMenu) {
    ...
    async function sendChatMessage() {
        ...
        // A direct request to be called rings the phone for real
        // instead of asking the text pipeline for a reply — that
        // pipeline can only ever type something back, never start a
        // call itself. Left blank, the opening line is generated the
        // normal way (same as any other incoming call) once Accept is
        // pressed.
        if (looksLikeCallRequest(text) && !isCallOpen()) {
